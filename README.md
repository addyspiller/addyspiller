...
Client repos are private, but I've shared READMEs for my personal projects below.

Want to talk through a project or discuss my approach? [Grab time here](https://calendly.com/addyspiller).
...
<td>Multi-step workflow used in client demos and data partner conversations. Integrates ArcGIS for location data. Spec'd for direct dev shop handoff.</td>
